                  ...
                  children: <Widget>[
                    ...
                    AspectRatio(
                      ...
                      child: FadeAnimation(1.1,Container( 
                        ...
                        child: Center(
                          child: Text(
                            "Sneakers", style: TextStyle(fontSize: 17), ),
                        ),
                      )),
                    ),
                    AspectRatio(
                      ...
                      child: FadeAnimation(1.2,Container( 
                        ...
                        child: Center(
                          child: Text(
                            "Football", style: TextStyle(fontSize: 17), ),
                        ),
                      )),
                    ),
                      AspectRatio(
                      ...
                      child: FadeAnimation(1.3,Container( 
                        ...
                        child: Center(
                          child: Text(
                            "Soccer", style: TextStyle(fontSize: 17), ),
                        ),
                      )),
                    ),
                     AspectRatio(
                      ...
                      child: FadeAnimation(1.4,Container( 
                        ...
                        child: Center(
                          child: Text(
                            "Golf", style: TextStyle(fontSize: 17), ),
                        ),
                      )),
                    ),
                  ],
                ...
                children: <Widget>[
                  Expanded(
                    child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                      children: <Widget>[
                        FadeAnimation(1.1,Text("Sneakers", style: TextStyle(color: Colors.white,
